...
# SSE transport — endpoint is relative to the mcp_app mount point.
# SseServerTransport automatically prepends scope['root_path'] (the full mount path),
# so we only need to specify "/messages" here.
